...
/**
 * Marka ikonları. Lucide sürümünde marka setleri bulunmadığı için
 * WhatsApp / Instagram / Facebook ikonları burada tanımlanır.
 * Hepsi currentColor kullanır ve dekoratiftir (aria-hidden).
 */
